package eu.uberdust.rest.controller.html.slse;
 ...
 */
public final class ListSlsesController extends AbstractRestController {
     ...
     * Logger.
     */
    private static final Logger LOGGER = Logger.getLogger(ListSlsesController.class);

    /**
     * Constructor.
     */
    public ListSlsesController() {
        super();
    ...
    /**
     * Sets slse peristence manager.
     *
     * @param slseManager slse persistence manager.
     */
    public void setSlseManager(final SlseController slseManager) {
    ...
    protected ModelAndView handle(final HttpServletRequest request, final HttpServletResponse response,
        ...
        final List<String> capabilities = slseManager.listNames(testbed);

        // Prepare data to pass to jsp
        final Map<String, Object> refData = new HashMap<String, Object>();
        refData.put("testbed", testbed);
        refData.put("slses", capabilities);
        return new ModelAndView("slse/list.html", refData);
    }
}
